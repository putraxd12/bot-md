...
kurr.send5ButImg(m.chat, anu, ` BOT HOSTING BY NTUYNESIA🤖 `, fatihgans, btn)
break
...
case 'group': case 'grup': {
                ...
                let buttons = [
                    ...
                    await kurr.sendButtonText(m.chat, buttons, `Mode Group`, '© 𝑪𝒐𝒑𝒚𝒓𝒊𝒈𝒉𝒕 𝑩𝒚 NTUY✓', m)
...
NOTE : DILARANG JUAL BELIKAN !! KARNA INI KHUSUS ✓`)
                                          break
case 'testi':
                                          m.reply(` 𝗧𝗘𝗦𝗧𝗜𝗠𝗢𝗡𝗜 𝗕𝗬 SAL¹⁹ !!\n𝗡𝗜 𝗧𝗘𝗦𝗧𝗢𝗗 : https://imageshack.com/user/ntuy-testimoni`)
                                          break
case 'shorlink':
if(from != "ID GROUPNYA") return m.reply("maaf su fitur ini dapet di gunakan group tertentu")
...
case 'antilink': {
                ...
                m.reply(`Antilink Tidak Aktif !`)
                 ...
                 let buttons = [
                    ...
                    await kurr.sendButtonText(m.chat, buttons, `Mode Antilink`, '© NTUY-MD', m)
                }
             }
             break
...
case 'bcgc': case 'bcgroup': {
                if (!isCreator) throw mess.owner
                if (!text) throw `Text mana?\n\nExample : ${prefix + command} NTUY-Botz`
                ...
                for (let i of anu) {
                    ...
                    let btn = [{
                      ...
                      kurr.send5ButImg(i, txt, '© NTUYBotz', global.thumb, btn)
                    }
